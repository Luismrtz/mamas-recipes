...
const MainpageRecipe = ({recipe: {_id, img, time, nameOfRecipe, description, beverage, dessert, dish}}) => {
    ...
    return  (
        ...
        <div className={styles.container}>
            ...
            <div   className={styles.imgOverlay}>
              ...
              <div className={styles.overlayContainer}>
                    ...
                    <div className={styles.bwrapper}>
                            <Link to={'/showrecipe/' + _id} className={styles.button1}>Details</Link>
            ...
            <div className={styles.textWrap}>
                    ...
                    <div className={styles.timeWrap}><div className="fa fa-clock-o fa-lg"></div><p className={styles.iconGap}>{time? time : 'N/A'}</p></div>
